...
export const ParticipantHeader: React.FC = () => {
  ...
  return (
    <>
      <header
        className={`sticky top-0 z-30 w-full backdrop-blur-2xl px-4 py-3 transition-colors duration-300 ${
          isDark
            ? 'bg-[#0B0F19]/85 border-b border-white/[0.08] text-white shadow-xl shadow-black/20'
        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="p-1.5 rounded-xl bg-white/5 hover:bg-white/10 text-slate-300 hover:text-orange-400 border border-white/5 transition-all cursor-pointer"
            ...
            <Link to="/dashboard" className="flex items-center gap-2 group">
              {/* Flame Logo */}
              <div className="w-7 h-7 rounded-xl bg-gradient-to-br from-orange-500 to-amber-500 flex items-center justify-center text-white shadow-sm shadow-orange-500/30 group-hover:scale-105 transition-transform">
          ...
          <nav className="hidden md:flex items-center gap-1.5 p-1 rounded-2xl bg-slate-200/50 dark:bg-white/[0.04] border border-slate-200/80 dark:border-white/[0.08] backdrop-blur-md">
            {[
              ...
              <NavLink
                ...
                to={link.path}
                className={({ isActive }) =>
                  `px-4 py-1.5 rounded-xl text-xs font-black font-mono tracking-wide transition-all relative flex items-center gap-1.5 ${
                    isActive
                      ? 'bg-gradient-to-r from-orange-500 to-amber-500 text-white shadow-xs shadow-orange-500/30'
                      : isDark
              ...
              >
                ...
                {link.path === '/news' && unreadNewsCount > 0 && (
                  <span className="w-4 h-4 rounded-full bg-orange-500 text-white text-[9px] font-black font-mono flex items-center justify-center shadow-xs">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={() => setIsDrawerOpen(true)}
              className="flex items-center gap-2 px-3.5 py-1.5 rounded-xl bg-slate-100 dark:bg-white/5 border border-slate-200/80 dark:border-white/10 text-xs font-black font-mono text-slate-700 dark:text-slate-200 hover:border-orange-500/40 hover:bg-white/10 transition-all cursor-pointer shadow-xs"
            >
